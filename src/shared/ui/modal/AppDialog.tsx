...
const AppDialog = ({
  ...
  return (
    <dialog
      ...
      className={`m-auto backdrop:bg-slate-950/50 w-full ${maxWidthClassName} rounded-[32px] bg-white p-0 text-left shadow-[0_24px_80px_rgba(15,23,42,0.22)] backdrop:backdrop-blur-[2px]`}
    >
