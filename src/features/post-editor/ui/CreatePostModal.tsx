...
import { createPost, updatePost } from '@/features/post-actions';
import {
  postCategoryIdLabelMap,
  postCategoryIdMap,
  postCategoryOptions,
  type MainPostCategory,
} from '@/widgets/post-section/model/constants';
...
const toPostCategory = (
  ...
  if (post.categoryId !== undefined && post.categoryId !== null) {
    return postCategoryIdLabelMap[post.categoryId] ?? fallbackCategory;
  }
