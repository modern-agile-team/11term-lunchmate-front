  ...
  return (
    <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-20 w-full max-w-4xl items-center justify-between px-6">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-2 rounded-2xl border border-indigo-300 px-4 py-2 text-sm font-semibold text-indigo-500 transition hover:bg-indigo-50"
        >
